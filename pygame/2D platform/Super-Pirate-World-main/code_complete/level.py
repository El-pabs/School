...
class Level:
    ...
    def __init__(self, tmx_map, level_frames, audio_files, data, switch_stage):
        ...
        # Get level data from the tmx_map
        ...
        # Store frames for pearls and particles
        self.pearl_surf = level_frames['pearl']
        self.particle_frames = level_frames['particle']

        # Store audio files for coins, damage, and pearls
    ...
    def setup(self, tmx_map, level_frames, audio_files):
        # Create tiles for each layer in the tmx_map
    ...
    # Check for collisions with pearls
