...
# Define the Player class, which represents the player character in the game
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, pos, groups, collision_sprites, semi_collision_sprites, frames, data, attack_sound, jump_sound):
        ...
        # Set the initial state and facing direction
        ...
        # Set the hitbox rectangle for the sprite
        self.hitbox_rect = self.rect.inflate(-76, -36)
        # Store the old rectangle for the sprite
        ...
        # Set the collision sprites
        self.collision_sprites = collision_sprites
        self.semi_collision_sprites = semi_collision_sprites
        # Initialize surface contact variables
        ...
        # Set the attack and jump sounds
    ...
    # Check if the player is in contact with a surface
    ...
    # Flicker the player sprite when hit
    def flicker(self):
